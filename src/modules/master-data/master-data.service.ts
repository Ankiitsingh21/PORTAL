...
export const listLocalitiesByCity = (city: string) =>
  repo.listLocalitiesByCity(city);
...
// ───────────── Job roles ─────────────
export const listJobRoles = (functionId?: number) =>
  repo.listJobRoles(functionId);
export const createJobRole = (name: string, functionId?: number) =>
  repo.createJobRole(name, functionId);
export const updateJobRole = (id: number, data: any) =>
  repo.updateJobRole(id, data);
