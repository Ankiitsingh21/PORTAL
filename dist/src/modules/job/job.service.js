...
exports.isRecruiterAssignedToIndustry = exports.listJobsByRecruiter = exports.assignJobToRecruiter = exports.deleteJob = exports.updateJobStatus = exports.updateJob = exports.getJob = exports.listJobs = exports.createJob = void 0;
...
const createJob = async (postedBy, body) => {
    const { title, description, industryId, functionId, jobRoleId, locationId, wageMin, wageMax, wageType, shiftType, jobType, headcountRequired, minExperienceMonths, skillIds, qualificationIds, } = body;
