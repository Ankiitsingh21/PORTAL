...
router.get("/", middlewares_1.requireAuth, (0, middlewares_1.requireRole)("super_admin"), ctrl.listAllApplications);
...
router.get("/recruiter", middlewares_1.requireAuth, (0, middlewares_1.requireRole)("recruiter", "super_admin"), ctrl.listRecruiterApplications);
