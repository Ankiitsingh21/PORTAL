...
// ───────────── List (role-aware) ─────────────
router.get("/", middlewares_1.requireAuth, (0, middlewares_1.requireRole)("worker", "recruiter", "super_admin"), ctrl.listJobs);
// ───────────── Single job ─────────────
router.get("/:id", middlewares_1.requireAuth, (0, middlewares_1.requireRole)("worker", "recruiter", "super_admin"), ctrl.getJob);
