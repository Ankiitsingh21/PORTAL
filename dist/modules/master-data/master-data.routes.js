...
router.patch("/qualifications/:id", middlewares_1.requireAuth, (0, middlewares_1.requireRole)("super_admin"), ctrl.updateQualification);
router.delete("/qualifications/:id", middlewares_1.requireAuth, (0, middlewares_1.requireRole)("super_admin"), ctrl.deleteQualification);
